...
function majControl_majMonad_majWriter_majClass_listens($dictMonadWriter_0) {
  ...
  $pure_3_2 = ($GLOBALS['Control_Applicative_pure'])((($Monad1_1_0)->{'Applicative0'})(null));
  ...
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Control_Bind_bind'])($Bind1_2_1))((($dictMonadWriter_0)->{'listen'})($m_5)))(function($v_6) use ($f_4, $pure_3_2) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Data_Function_apply'])($pure_3_2))((($GLOBALS['Data_Tuple_Tuple'])(($v_6)->{'value0'}))(($f_4)(($v_6)->{'value1'})));
  goto __end;;
  __end:
...
function majControl_majMonad_majWriter_majClass_censor($dictMonadWriter_0) {
  ...
  $__res = function($m_5) use ($Bind1_2_1, $dictMonadWriter_0, $f_4, $pure_3_2) {
  $__num = \func_num_args();
  $__res = (($dictMonadWriter_0)->{'pass'})(((($GLOBALS['Control_Bind_bind'])($Bind1_2_1))($m_5))(function($a_6) use ($f_4, $pure_3_2) {
  $__num = \func_num_args();
  $__res = (($GLOBALS['Data_Function_apply'])($pure_3_2))((($GLOBALS['Data_Tuple_Tuple'])($a_6))($f_4));
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}));

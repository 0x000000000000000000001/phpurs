...
$GLOBALS['Control_Monad_Writer_writer_closure'] = ((($GLOBALS['Control_Semigroupoid_compose'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))($GLOBALS['Control_Monad_Writer_Trans_WriterT']))(($GLOBALS['Control_Applicative_pure'])($GLOBALS['Data_Identity_applicativeIdentity']));
...
$GLOBALS['Control_Monad_Writer_runWriter_closure'] = ((($GLOBALS['Control_Semigroupoid_compose'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))(($GLOBALS['Data_Newtype_unwrap'])(null)))($GLOBALS['Control_Monad_Writer_Trans_runWriterT']);
...
function majControl_majMonad_majWriter_mapmajWriter($f_0) {
  ...
  $__local_var_1_0 = ((($GLOBALS['Control_Semigroupoid_compose'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))($GLOBALS['Data_Identity_Identity']))(((($GLOBALS['Control_Semigroupoid_compose'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))($f_0))(($GLOBALS['Data_Newtype_unwrap'])(null)));
...
function majControl_majMonad_majWriter_execmajWriter($m_0) {
  ...
  $__res = ($GLOBALS['Data_Tuple_snd'])(\Control\Monad\Writer\majControl_majMonad_majWriter_runmajWriter($m_0));
  goto __end;;
  __end:
  return 1 < $__num ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}

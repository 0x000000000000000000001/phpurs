...
const frequency = dictMonadGen => dictFoldable1 => {
  ...
  return xs => dictMonadGen.Monad0().Bind1().bind(dictMonadGen.chooseFloat(0.0)(foldMap(Data$dTuple.fst)(xs)))(Control$dSemigroupoid.composeImpl(Data$dTuple.snd)(foldMap1(freqSemigroup)(xs)));
};

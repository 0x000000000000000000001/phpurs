...
$__t1 = ((($go_1_0)((($fn_0)($acc_2))(($lhs_3)->value0)))($rhs_4))(new Phpurs_Data0("Empty"));
} else {
if ((is_object($lhs_3) && (($lhs_3)->tag === "Append"))) {
if ((is_object(($lhs_3)->value1) && ((($lhs_3)->value1)->tag === "Empty"))) {
$__t2 = ((($go_1_0)($acc_2))(($lhs_3)->value0))($rhs_4);
} else {
if ((is_object($rhs_4) && (($rhs_4)->tag === "Empty"))) {
$__t2 = ((($go_1_0)($acc_2))(($lhs_3)->value0))(($lhs_3)->value1);
} else {
$__t2 = ((($go_1_0)($acc_2))(($lhs_3)->value0))(new Phpurs_Data2("Append", ($lhs_3)->value1, $rhs_4));
};
};
$__t1 = $__t2;
} else {
...
$__t3 = ((($go_1_0)($acc_2))($rhs_4))(new Phpurs_Data0("Empty"));
};
$__t1 = $__t3;
} else {
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t1 = null;
  ...
  $__num = \func_num_args();
  $go_1_4 = null;
  $go_1_4 = (function() use (&$fn_0, &$go_1_4) {
  $__fn = function($acc_2, $lhs_3 = null, $rhs_4 = null) use (&$fn_0, &$go_1_4, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 3) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 3);
  }
  if ((is_object($rhs_4) && (($rhs_4)->tag === "Node"))) {
$__t5 = ((($go_1_4)((($fn_0)(($rhs_4)->value0))($acc_2)))(new Phpurs_Data0("Empty")))($lhs_3);
} else {
if ((is_object($rhs_4) && (($rhs_4)->tag === "Append"))) {
if ((is_object(($rhs_4)->value0) && ((($rhs_4)->value0)->tag === "Empty"))) {
$__t6 = ((($go_1_4)($acc_2))($lhs_3))(($rhs_4)->value1);
} else {
if ((is_object($lhs_3) && (($lhs_3)->tag === "Empty"))) {
$__t6 = ((($go_1_4)($acc_2))(($rhs_4)->value0))(($rhs_4)->value1);
} else {
$__t6 = ((($go_1_4)($acc_2))(new Phpurs_Data2("Append", $lhs_3, ($rhs_4)->value0)))(($rhs_4)->value1);
};
};
$__t5 = $__t6;
} else {
...
$__t7 = ((($go_1_4)($acc_2))(new Phpurs_Data0("Empty")))($lhs_3);
};
$__t5 = $__t7;
} else {
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t5 = null;
  ...
  $__res = (function() use (&$go_1_4) {
  $__fn = function($a_2, $b_3 = null) use (&$go_1_4, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ((($go_1_4)($a_2))(new Phpurs_Data0("Empty")))($b_3);
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };

...
const foldableList = {
  ...
  foldMap: dictMonoid => {
    ...
    return f => foldableList.foldl(acc => Control$dSemigroupoid.composeImpl(dictMonoid.Semigroup0().append(acc))(f))(mempty);
  }
};
...
const foldableWithIndexList = {
  ...
  foldMapWithIndex: dictMonoid => {
    const mempty = dictMonoid.mempty;
    return f => foldableWithIndexList.foldlWithIndex(i => acc => Control$dSemigroupoid.composeImpl(dictMonoid.Semigroup0().append(acc))(f(i)))(mempty);
  },
...
const foldableWithIndexNonEmptyList = {
  foldMapWithIndex: dictMonoid => {
    ...
    return f => v => foldMapWithIndex1(Control$dSemigroupoid.composeImpl(f)(v2 => {
...
const functorWithIndexNonEmptyList = {
  mapWithIndex: fn => v => mapWithIndex(Control$dSemigroupoid.composeImpl(fn)(v2 => {
    if (v2.tag === "Nothing") { return 0; }
    if (v2.tag === "Just") { return 1 + v2._1 | 0; }
    $runtime.fail();
  }))(v),
...
const traversableList = {
  traverse: dictApplicative => {
    ...
    return f => Control$dSemigroupoid.composeImpl(Apply0.Functor0().map((() => {
      const go = go$a0$copy => go$a1$copy => {
        let go$a0 = go$a0$copy, go$a1 = go$a1$copy, go$c = true, go$r;
        while (go$c) {
          const b = go$a0, v = go$a1;
      ...
      const go = go$a0$copy => go$a1$copy => {
        ...
        while (go$c) {
          ...
          if (v.tag === "Cons") {
            go$a0 = Control$dSemigroupoid.composeImpl(b$1 => Apply0.apply(Apply0.Functor0().map(b$2 => a => $List("Cons", a, b$2))(b))(b$1))(f)(v._1);
            go$a1 = v._2;
            continue;
          }
          $runtime.fail();
...
const traversableWithIndexList = {
  traverseWithIndex: dictApplicative => {
    ...
    return f => Control$dSemigroupoid.composeImpl(Apply0.Functor0().map((() => {
      ...
      return go(Nil);
    })()))(foldableWithIndexList.foldlWithIndex(i => acc => Control$dSemigroupoid.composeImpl(b => Apply0.apply(Apply0.Functor0().map(b$1 => a => $List("Cons", a, b$1))(acc))(b))(f(i)))(dictApplicative.pure(Nil)));
  },
...
const traversableWithIndexNonEmptyList = {
  traverseWithIndex: dictApplicative => {
    ...
    return f => v => dictApplicative.Apply0().Functor0().map(NonEmptyList)(traverseWithIndex1(Control$dSemigroupoid.composeImpl(f)(v2 => {
      if (v2.tag === "Nothing") { return 0; }
      if (v2.tag === "Just") { return 1 + v2._1 | 0; }
      $runtime.fail();
    }))(v));
    ...
    return f => v => Functor0.map(v1 => {
      ...
      const go = go$a0$copy => go$a1$copy => {
        ...
        while (go$c) {
          ...
          if (v$1.tag === "Cons") {
            go$a0 = Control$dSemigroupoid.composeImpl(b$1 => dictApply.apply(dictApply.Functor0().map(b$2 => a => Data$dNonEmpty.$NonEmpty(a, $List("Cons", b$2._1, b$2._2)))(b))(b$1))(f)(v$1._1);
            go$a1 = v$1._2;
            continue;
          }
          $runtime.fail();

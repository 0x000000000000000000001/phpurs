...
\PhpursThunks::$thunks['Data_Ord_Min_monoidMin'] = function() { $v = function($dictBounded_0) {
  ...
  $semigroupMin1_2_3 = (object)["append" => (function() use (&$__local_var_1_0) {
...
$__t2 = null;
  ...
  $__res = (object)["mempty" => ($dictBounded_0)->top, "Semigroup0" => function($dollar__unused_3) use (&$semigroupMin1_2_3) {
  $__num = \func_num_args();
  $__res = $semigroupMin1_2_3;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];

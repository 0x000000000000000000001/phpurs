...
6. **Prochaine priorité : suite R10, mesurer `E = null` sur copie.** RBTree représente environ 90 % du total restant. Prouver le domaine privé fermé, mesurer le gain et vérifier anciennes racines/frontières avant toute intégration. R4 peut ensuite simplifier les boucles TCO, dont le petit coût restant dans Lazy.
7. B1–B4 : accélérer la boucle de développement, avec mesures de compilation séparées.

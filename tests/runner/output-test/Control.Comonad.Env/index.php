...
function majControl_majComonad_majEnv_runmajEnv($v_0) {
  ...
  $__res = ((($GLOBALS['Data_Functor_map'])($GLOBALS['Data_Tuple_functorTuple']))(($GLOBALS['Data_Newtype_unwrap'])(null)))($v_0);
  goto __end;;
  __end:
...
// Control_Comonad_Env_mapEnv_closure
$GLOBALS['Control_Comonad_Env_mapEnv_closure'] = ($GLOBALS['Data_Functor_map'])(($GLOBALS['Control_Comonad_Env_Trans_functorEnvT'])($GLOBALS['Data_Identity_functorIdentity']));

// Control_Comonad_Env_mapEnv
function majControl_majComonad_majEnv_mapmajEnv($v_0, $v_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majControl_majComonad_majEnv_mapmajEnv';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ($GLOBALS['Control_Comonad_Env_mapEnv_closure'])($v_0, $v_1);
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}
...
function majControl_majComonad_majEnv_env($e_0, $a_1 = null) {
  ...
  $__res = (($GLOBALS['Data_Function_apply'])($GLOBALS['Control_Comonad_Env_Trans_EnvT']))((($GLOBALS['Data_Function_apply'])(($GLOBALS['Data_Tuple_Tuple'])($e_0)))($a_1));
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}

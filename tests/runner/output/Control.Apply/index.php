...
\PhpursThunks::$thunks['Control_Apply_applyArray'] = function() { $v = (object)["apply" => ($GLOBALS['Control_Apply_arrayApply'] ?? \PhpursThunks::eval('Control_Apply_arrayApply')), "Functor0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();

...
const genNonEmpty = dictMonadRec => dictMonadGen => {
  ...
  return dictUnfoldable => {
    ...
    return gen => Apply0.apply(Apply0.Functor0().map(Data$dNonEmpty.NonEmpty)(gen))(dictMonadGen.resize(Control$dSemigroupoid.composeImpl(max(0))(v => v - 1 | 0))(unfoldable2(gen)));
  };
};

...
const functorWithIndexNonEmptyList = {
  mapWithIndex: f => v => Data$dLazy.defer(v1 => mapWithIndex(Control$dSemigroupoid.composeImpl(f)(v2 => {
    if (v2.tag === "Nothing") { return 0; }
    if (v2.tag === "Just") { return 1 + v2._1 | 0; }
    $runtime.fail();
  }))(Data$dLazy.force(v))),
...
const traversableWithIndexNonEmptyList = {
  traverseWithIndex: dictApplicative => {
    ...
    return f => v => dictApplicative.Apply0().Functor0().map(xxs => Data$dLazy.defer(v1 => xxs))(traverseWithIndex1(Control$dSemigroupoid.composeImpl(f)(v2 => {
      if (v2.tag === "Nothing") { return 0; }
      if (v2.tag === "Just") { return 1 + v2._1 | 0; }
      $runtime.fail();
    }))(Data$dLazy.force(v)));

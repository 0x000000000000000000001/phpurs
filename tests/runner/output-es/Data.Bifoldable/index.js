...
const bitraverse_ = dictBifoldable => dictApplicative => {
  ...
  return f => g => dictBifoldable.bifoldr(Control$dSemigroupoid.composeImpl(applySecond)(f))(Control$dSemigroupoid.composeImpl(applySecond)(g))(dictApplicative.pure());
};
...
const bifoldlDefault = dictBifoldable => {
  ...
  return f => g => z => p => bifoldMap1(Control$dSemigroupoid.composeImpl(Data$dMonoid$dDual.Dual)(Control$dSemigroupoid.composeImpl(Data$dMonoid$dEndo.Endo)(b => a => f(a)(b))))(Control$dSemigroupoid.composeImpl(Data$dMonoid$dDual.Dual)(Control$dSemigroupoid.composeImpl(Data$dMonoid$dEndo.Endo)(b => a => g(a)(b))))(p)(z);
};
const bifoldrDefault = dictBifoldable => {
  const bifoldMap1 = dictBifoldable.bifoldMap(monoidEndo);
  return f => g => z => p => bifoldMap1(Control$dSemigroupoid.composeImpl(Data$dMonoid$dEndo.Endo)(f))(Control$dSemigroupoid.composeImpl(Data$dMonoid$dEndo.Endo)(g))(p)(z);
};
...
const biany = dictBifoldable => dictBooleanAlgebra => {
  ...
  return p => q => Control$dSemigroupoid.composeImpl(Unsafe$dCoerce.unsafeCoerce)(bifoldMap2(Control$dSemigroupoid.composeImpl(Data$dMonoid$dDisj.Disj)(p))(Control$dSemigroupoid.composeImpl(Data$dMonoid$dDisj.Disj)(q)));
};
const biall = dictBifoldable => dictBooleanAlgebra => {
  ...
  return p => q => Control$dSemigroupoid.composeImpl(Unsafe$dCoerce.unsafeCoerce)(bifoldMap2(Control$dSemigroupoid.composeImpl(Data$dMonoid$dConj.Conj)(p))(Control$dSemigroupoid.composeImpl(Data$dMonoid$dConj.Conj)(q)));
};
export {
  biall,
  biany,

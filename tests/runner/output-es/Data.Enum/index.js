    ...
    return {
      succ: v => {
        if (v.tag === "Left") {
          ...
          if ($1.tag === "Nothing") { return Data$dMaybe.$Maybe("Just", Data$dEither.$Either("Right", bottom2)); }
      ...
      pred: v => {
        ...
        if (v.tag === "Right") {
          ...
          if ($1.tag === "Nothing") { return Data$dMaybe.$Maybe("Just", Data$dEither.$Either("Left", top2)); }
          if ($1.tag === "Just") { return $0($1._1); }
        }
        $runtime.fail();
      },

...
\PhpursThunks::$thunks['Data_Ord_Max_monoidMax'] = function() { $v = function($dictBounded_0) {
  ...
  $semigroupMax1_2_3 = (object)["append" => (function() use (&$__local_var_1_0) {
...
$__t2 = null;
  ...
  $__res = (object)["mempty" => ($dictBounded_0)->bottom, "Semigroup0" => function($dollar__unused_3) use (&$semigroupMax1_2_3) {
  $__num = \func_num_args();
  $__res = $semigroupMax1_2_3;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];

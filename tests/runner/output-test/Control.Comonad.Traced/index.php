...
$GLOBALS['Control_Comonad_Traced_traced_closure'] = ((($GLOBALS['Control_Semigroupoid_composeFlipped'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))($GLOBALS['Data_Identity_Identity']))($GLOBALS['Control_Comonad_Traced_Trans_TracedT']);
...
function majControl_majComonad_majTraced_runmajTraced($v_0) {
  ...
  $__res = (($GLOBALS['Data_Newtype_unwrap'])(null))($v_0);
  goto __end;;
  __end:

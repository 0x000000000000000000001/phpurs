...
$__t4 = new Phpurs_Data1("Just", $x_6);
} else {
$v_7_2 = (($dictEnum_2)->succ)($x_6);
if ((is_object($v_7_2) && (($v_7_2)->tag === "Just"))) {
$__t3 = (($go_4_1)(((($GLOBALS['Data_Ring_intSub'] ?? \PhpursThunks::eval('Data_Ring_intSub')))($i_5))(1)))(($v_7_2)->value0);
} else {
...
$__t5 = (($go_4_1)($i__prime___3))($bottom2_1_0);
};
  $__res = $__t5;
  goto __end;;
  __end:
...
$__t2 = (($go_1_0)(((($GLOBALS['Data_Semiring_intAdd'] ?? \PhpursThunks::eval('Data_Semiring_intAdd')))($i_2))(1)))(($v_4_1)->value0);
} else {
...
$__t3 = (($go_3_1)(((($GLOBALS['Data_Semiring_intAdd'] ?? \PhpursThunks::eval('Data_Semiring_intAdd')))($i_4))(1)))(($v_6_2)->value0);
} else {

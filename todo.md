...
4. [Profil après R9 terminé](audit/2026-09-08/rbtree-after-r9/report.md) : couleurs scalaires et arbre vide nullable donnent 223–227 ms dans une copie qui change la frontière PHP. Le [prototype interne R10](audit/2026-09-08/r10-boundary/report.md) conserve maintenant les chemins publics et mesure les seules couleurs scalaires : total 253–261 ms contre 304–310 ms, mêmes 2,58 millions de nœuds et anciennes racines intactes. **Pas intégré au générateur** : la prochaine étape est de porter l'analyse et la duplication dans les AST de PHPurs.
5. B1–B4 : accélérer la boucle de développement, avec mesures de compilation séparées.
...
- [ ] **Prochaine petite étape : `E = null`.** Prouver séparément le domaine fermé et l'absence de collision avec une autre représentation dans les régions R10, préserver les frontières et anciennes racines, puis remesurer avant extension.

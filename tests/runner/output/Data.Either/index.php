...
\PhpursThunks::$thunks['Data_Either_ordEither'] = function() { $v = function($dictOrd_0) {
  ...
  $eqEither2_4_3 = (object)["eq" => (function() use (&$__local_var_1_0, &$__local_var_3_1) {
...
$__t4 = null;
  ...
  return $__fn;
})(), "Eq0" => function($dollar__unused_5) use (&$eqEither2_4_3) {
  $__num = \func_num_args();
  $__res = $eqEither2_4_3;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Data_Either_ord1Either'] = function() { $v = function($dictOrd_0) {
  ...
  $eq1Either1_3_3 = (object)["eq1" => (function() use (&$__local_var_2_1) {
...
$__t2 = ((is_object($x_4) && (($x_4)->tag === "Right")) && ((is_object($y_5) && (($y_5)->tag === "Right")) && ((($dictEq1_3)->eq)(($x_4)->value0))(($y_5)->value0)));
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}, "Eq10" => function($dollar__unused_4) use (&$eq1Either1_3_3) {
  $__num = \func_num_args();
  $__res = $eq1Either1_3_3;
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}];

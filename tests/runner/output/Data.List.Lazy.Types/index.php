...
$__t4 = (($go_3_0)((($GLOBALS['Data_List_Lazy_Types_step'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_step')))(($v_4)->value1)))((($GLOBALS['Data_List_Lazy_Types_step'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_step')))(($v1_5)->value1));
} else {
$__t4 = $v2_6_3;
};
$__t1 = $__t4;
...
$__t2 = (($go_1_0)((($op_0)($b_2))(($v_4_1)->value0)))(($v_4_1)->value1);
} else {
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t2 = null;
};
  ...
  $__num = \func_num_args();
  $mempty_1_3 = ($dictMonoid_0)->mempty;
  $__res = function($f_2) use (&$dictMonoid_0, &$mempty_1_3) {
  $__num = \func_num_args();
...
$__local_var_4_7 = (((((($GLOBALS['Data_List_Lazy_Types_foldableList'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_foldableList')))->foldr)((function() use (&$f_0) {
...
$__t1 = (($GLOBALS['Data_Lazy_defer'] ?? \PhpursThunks::eval('Data_Lazy_defer')))(function($v_5) use (&$__local_var_3_2, &$__local_var_4_7) {
  $__num = \func_num_args();
  $__res = new Phpurs_Data2("Cons", $__local_var_3_2, $__local_var_4_7);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
});
...
\PhpursThunks::$thunks['Data_List_Lazy_Types_foldableWithIndexList'] = function() { $v = (object)["foldrWithIndex" => (function() {
  ...
  $v_3_2 = ((((($GLOBALS['Data_List_Lazy_Types_foldableList'] ?? \PhpursThunks::eval('Data_List_Lazy_Types_foldableList')))->foldl)(function($v1_3) {
  $__num = \func_num_args();
  ...
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}))(new Phpurs_Data2("Tuple", ($v_3_2)->value0, $b_1)))(($v_3_2)->value1))->value1;
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };

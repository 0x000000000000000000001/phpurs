...
$GLOBALS['Control_Monad_Reader_Class_monadAskFun'] = (object)["ask" => ($GLOBALS['Control_Category_identity'])($GLOBALS['Control_Category_categoryFn']), "Monad0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
$GLOBALS['Control_Monad_Reader_Class_monadReaderFun'] = (object)["local" => ($GLOBALS['Control_Semigroupoid_composeFlipped'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']), "MonadAsk0" => function($_dollar___unused_0) {
  $__num = \func_num_args();
...
function majControl_majMonad_majReader_majClass_asks($dictMonadAsk_0) {
  ...
  $ask1_2_1 = ($GLOBALS['Control_Monad_Reader_Class_ask'])($dictMonadAsk_0);
  $__res = function($f_3) use ($Functor0_1_0, $ask1_2_1) {
  $__num = \func_num_args();
  $__res = ((($GLOBALS['Data_Functor_map'])($Functor0_1_0))($f_3))($ask1_2_1);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
};

...
await build({
  ...
  plugins: [{ name: 'disable-compact-loops', setup(b) {
    b.onLoad({ filter: /Phpurs\.CompactLoops\/index\.js$/ }, () => ({ contents: 'export const optimize = label => signature => expression => expression;', loader: 'js' }));
  }}],
});

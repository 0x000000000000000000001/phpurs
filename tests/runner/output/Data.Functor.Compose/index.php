...
\PhpursThunks::$thunks['Data_Functor_Compose_eqCompose'] = function() { $v = (function() {
  ...
  $eq11_3_1 = (($dictEq1_0)->eq1)((object)["eq" => (function() use (&$eq11_3_0) {
  ...
  $__res = (object)["eq" => (function() use (&$eq11_3_1) {
  $__fn = function($v_4, $v1_5 = null) use (&$eq11_3_1, &$__fn) {
  $__num = \func_num_args();
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = (($eq11_3_1)((($GLOBALS['Unsafe_Coerce_unsafeCoerce'] ?? \PhpursThunks::eval('Unsafe_Coerce_unsafeCoerce')))($v_4)))((($GLOBALS['Unsafe_Coerce_unsafeCoerce'] ?? \PhpursThunks::eval('Unsafe_Coerce_unsafeCoerce')))($v1_5));
  goto __end;;
  __end:
  return $__num > 2 ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
  };

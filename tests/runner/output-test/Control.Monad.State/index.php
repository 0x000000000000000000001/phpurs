...
function majControl_majMonad_majState_runmajState($v_0) {
  ...
  $__res = ((($GLOBALS['Control_Semigroupoid_compose'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))(($GLOBALS['Data_Newtype_unwrap'])(null)))($v_0);
  goto __end;;
  __end:
...
function majControl_majMonad_majState_mapmajState($f_0) {
  ...
  $__res = ($GLOBALS['Control_Monad_State_Trans_mapStateT'])(((($GLOBALS['Control_Semigroupoid_compose'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))($GLOBALS['Data_Identity_Identity']))(((($GLOBALS['Control_Semigroupoid_compose'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))($f_0))(($GLOBALS['Data_Newtype_unwrap'])(null))));
  goto __end;;
  __end:
  return 1 < $__num ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}

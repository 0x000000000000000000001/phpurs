...
if (($p_0)(($v_4_1)->value0)) {
$__t3 = ($go_2_0)(((($GLOBALS['Data_Semiring_intAdd'] ?? \PhpursThunks::eval('Data_Semiring_intAdd')))($i_3))(1));
} else {
...
$__t2 = null;
  ...
  $breakIndex_3_4 = ($go_2_0)(0);
  if ((is_object($breakIndex_3_4) && (($breakIndex_3_4)->tag === "Just"))) {
switch (($breakIndex_3_4)->value0) {
case 0:
$__t6 = (object)["init" => [], "rest" => $arr_1];
break;
default:
$__t6 = (object)["init" => (((($GLOBALS['Data_Array_slice'] ?? \PhpursThunks::eval('Data_Array_slice')))(0))(($breakIndex_3_4)->value0))($arr_1), "rest" => (((($GLOBALS['Data_Array_slice'] ?? \PhpursThunks::eval('Data_Array_slice')))(($breakIndex_3_4)->value0))((($GLOBALS['Data_Array_length'] ?? \PhpursThunks::eval('Data_Array_length')))($arr_1)))($arr_1)];
break;
};
$__t5 = $__t6;
} else {
if ((is_object($breakIndex_3_4) && (($breakIndex_3_4)->tag === "Nothing"))) {
$__t5 = (object)["init" => $arr_1, "rest" => []];
} else {
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t5 = null;
};
...
\PhpursThunks::$thunks['Data_Array_transpose'] = function() { $v = function($xs_0) {
  ...
  $v_4_4 = (((($GLOBALS['Data_Foldable_foldlArray'] ?? \PhpursThunks::eval('Data_Foldable_foldlArray')))((function() use (&$idx_2) {
...
$__t2 = null;
  ...
  if ((is_object($v_4_4) && (($v_4_4)->tag === "Nothing"))) {
$__t5 = $allArrays_3;
} else {
if ((is_object($v_4_4) && (($v_4_4)->tag === "Just"))) {
$__t5 = (($go_1_0)(((($GLOBALS['Data_Semiring_intAdd'] ?? \PhpursThunks::eval('Data_Semiring_intAdd')))($idx_2))(1)))((($GLOBALS['Control_Monad_ST_Internal_run'] ?? \PhpursThunks::eval('Control_Monad_ST_Internal_run')))(((($GLOBALS['Data_Array_ST_withArray'] ?? \PhpursThunks::eval('Data_Array_ST_withArray')))((($GLOBALS['Data_Array_ST_push'] ?? \PhpursThunks::eval('Data_Array_ST_push')))(($v_4_4)->value0)))($allArrays_3)));
} else {
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t5 = null;
};
...
$__t1 = null;
  ...
  $i_4_2 = $__t1;
  $__res = (($GLOBALS['Partial_Unsafe__unsafePartial'] ?? \PhpursThunks::eval('Partial_Unsafe__unsafePartial')))(function($dollar__unused_5) use (&$i_4_2, &$x_1, &$ys_2) {
  $__num = \func_num_args();
  $__local_var_6_3 = (((($GLOBALS['Data_Array_insertAt'] ?? \PhpursThunks::eval('Data_Array_insertAt')))($i_4_2))($x_1))($ys_2);

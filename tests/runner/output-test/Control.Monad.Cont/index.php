...
function majControl_majMonad_majCont_runmajCont($cc_0, $k_1 = null) {
  ...
  $__res = (($GLOBALS['Data_Newtype_unwrap'])(null))(\Control\Monad\Cont\Trans\majControl_majMonad_majCont_majTrans_runmajContmajT($cc_0, ((($GLOBALS['Control_Semigroupoid_compose'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))($GLOBALS['Data_Identity_Identity']))($k_1)));
  goto __end;;
  __end:
...
function majControl_majMonad_majCont_mapmajCont($f_0) {
  ...
  $__res = ($GLOBALS['Control_Monad_Cont_Trans_mapContT'])(((($GLOBALS['Control_Semigroupoid_compose'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))($GLOBALS['Data_Identity_Identity']))(((($GLOBALS['Control_Semigroupoid_compose'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))($f_0))(($GLOBALS['Data_Newtype_unwrap'])(null))));
  goto __end;;
  __end:
  return 1 < $__num ? $__res(...\array_slice(\func_get_args(), 1)) : $__res;
}
...
function majControl_majMonad_majCont_cont($f_0, $c_1 = null) {
  ...
  $__res = ($f_0)(((($GLOBALS['Control_Semigroupoid_compose'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))(($GLOBALS['Data_Newtype_unwrap'])(null)))($c_1));
  goto __end;;
  __end:
  return 2 < $__num ? $__res(...\array_slice(\func_get_args(), 2)) : $__res;
}

...
names = ['CompactClosureLoops', 'FunctionFFIBoundary', 'TerminalInlining', 'UnaryCallableCaptures', 'BranchBindingSlots', 'RecursiveDictionaryInitialization', 'DeepCase', 'ShadowedRename', 'ShadowedTCOLet', 'TCOCase', 'TCOMutRec', 'CaseMultipleExpressions']
results = []
for name in names:

...
$__local_var_6_7 = (($GLOBALS['Data_Lazy_defer'] ?? \PhpursThunks::eval('Data_Lazy_defer')))(function($v_6 = null) use ($__local_var_3_4, $__local_var_5_6) {
  $__num = \func_num_args();
...
$__local_var_7_8 = (($GLOBALS['Data_List_Lazy_transpose'] ?? \PhpursThunks::eval('Data_List_Lazy_transpose')))((($GLOBALS['Data_Lazy_defer'] ?? \PhpursThunks::eval('Data_Lazy_defer')))(function($v_8 = null) use ($__local_var_4_5, $__local_var_7_8) {
  $__num = \func_num_args();
...
$__t3 = (($GLOBALS['Data_Lazy_defer'] ?? \PhpursThunks::eval('Data_Lazy_defer')))(function($v_8 = null) use ($__local_var_6_7, $__local_var_7_8) {
  $__num = \func_num_args();

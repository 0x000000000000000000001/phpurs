...
namespace Type\Data\Boolean;

// ALL IMPORTS: Prim, Prim.Boolean, Type.Data.Boolean, Type.Proxy
// TO REQUIRE: Type.Data.Boolean, Type.Proxy
...
$__t0 = (($v1_1)(($GLOBALS['Type_Data_Boolean_isBooleanFalse'] ?? \PhpursThunks::eval('Type_Data_Boolean_isBooleanFalse'))))(new Phpurs_Data0("Proxy"));
};
  $__res = $__t0;
  goto __end;;
  __end:
...
\PhpursThunks::$thunks['Type_Data_Boolean_ifTrue'] = function() { $v = (object)[]; return $v; };
\PhpursThunks::$thunks['Type_Data_Boolean_ifFalse'] = function() { $v = (object)[]; return $v; };

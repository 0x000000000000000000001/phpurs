...
const traversableLazy = {
  traverse: dictApplicative => f => l => dictApplicative.Apply0().Functor0().map(Control$dSemigroupoid.composeImpl(defer)(Data$dFunction.const))(f(force(l))),
  sequence: dictApplicative => l => dictApplicative.Apply0().Functor0().map(Control$dSemigroupoid.composeImpl(defer)(Data$dFunction.const))(force(l)),
...
const traversable1Lazy = {
  traverse1: dictApply => f => l => dictApply.Functor0().map(Control$dSemigroupoid.composeImpl(defer)(Data$dFunction.const))(f(force(l))),
  sequence1: dictApply => l => dictApply.Functor0().map(Control$dSemigroupoid.composeImpl(defer)(Data$dFunction.const))(force(l)),

...
// Control_Monad_Except_withExcept_closure
$GLOBALS['Control_Monad_Except_withExcept_closure'] = ($GLOBALS['Control_Monad_Except_Trans_withExceptT'])($GLOBALS['Data_Identity_functorIdentity']);

// Control_Monad_Except_withExcept
function majControl_majMonad_majExcept_withmajExcept($v_0, $v_1 = null) {
  $__num = \func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'majControl_majMonad_majExcept_withmajExcept';
  if ($__num < 2) {
    return phpurs_curry_fallback($__fn, \func_get_args(), 2);
  }
  $__res = ($GLOBALS['Control_Monad_Except_withExcept_closure'])($v_0, $v_1);
  goto __end;;
  __end:
...
$GLOBALS['Control_Monad_Except_runExcept_closure'] = ((($GLOBALS['Control_Semigroupoid_compose'])($GLOBALS['Control_Semigroupoid_semigroupoidFn']))(($GLOBALS['Data_Newtype_unwrap'])(null)))($GLOBALS['Control_Monad_Except_Trans_runExceptT']);

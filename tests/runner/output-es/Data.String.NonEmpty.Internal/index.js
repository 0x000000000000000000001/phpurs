...
const joinWith1 = dictFoldable1 => {
  ...
  return v => Control$dSemigroupoid.composeImpl(NonEmptyString)(xs => $0.foldl(v$1 => v1 => {
...
const join1With = dictFoldable1 => {
  const joinWith2 = joinWith(dictFoldable1.Foldable0());
  return splice => Control$dSemigroupoid.composeImpl(NonEmptyString)(joinWith2(splice));
};
const fromString = v => {

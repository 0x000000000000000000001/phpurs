...
$__t3 = null;
  ...
  $__res = new Phpurs_Data2("NonEmpty", (($f_0)(($v_1)->value0))(($v1_2)->value0), (($go_4_2)(new Phpurs_Data0("Nil")))(((($go_3_0)(($v_1)->value1))(($v1_2)->value1))(new Phpurs_Data0("Nil"))));
  goto __end;;
  __end:
  return $__num > 3 ? $__res(...\array_slice(\func_get_args(), 3)) : $__res;
  };
...
$__t4 = (($go_1_0)(new Phpurs_Data2("Cons", (($v1_3)->value0)->value0, $v_2)))(($v1_3)->value1);
} else {
throw new \Exception("Failed pattern match at " . __FILE__ . ":" . __LINE__);
$__t4 = null;
};

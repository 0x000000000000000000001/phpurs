...
\PhpursThunks::$thunks['Control_Monad_ST_Class_monadSTST'] = function() { $v = (object)["liftST" => (($GLOBALS['Control_Category_categoryFn'] ?? \PhpursThunks::eval('Control_Category_categoryFn')))->{'identity'}, "Monad0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();
...
\PhpursThunks::$thunks['Control_Monad_ST_Class_monadSTEffect'] = function() { $v = (object)["liftST" => ($GLOBALS['Unsafe_Coerce_unsafeCoerce'] ?? \PhpursThunks::eval('Unsafe_Coerce_unsafeCoerce')), "Monad0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();

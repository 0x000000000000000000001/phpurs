...
\PhpursThunks::$thunks['Data_Tuple_ringTuple'] = function() { $v = function($dictRing_0) {
  ...
  $semiringTuple1_3_3 = function($dictSemiring1_4) use (&$__local_var_1_0, &$one_2_1, &$zero_3_2) {
  $__num = \func_num_args();
  ...
  $__res = function($dictRing1_4) use (&$dictRing_0, &$semiringTuple1_3_3) {
  $__num = \func_num_args();
  $semiringTuple2_5_4 = ($semiringTuple1_3_3)((($dictRing1_4)->Semiring0)(($GLOBALS['Prim_undefined'] ?? \PhpursThunks::eval('Prim_undefined'))));

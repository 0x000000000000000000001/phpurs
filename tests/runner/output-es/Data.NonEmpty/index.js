...
const foldableWithIndexNonEmpty = dictFoldableWithIndex => {
  ...
  return {
    foldMapWithIndex: dictMonoid => {
      ...
      return f => v => dictMonoid.Semigroup0().append(f(Data$dMaybe.Nothing)(v._1))(foldMapWithIndex1(Control$dSemigroupoid.composeImpl(f)(Data$dMaybe.Just))(v._2));
    },
...
const traversableWithIndexNonEmpty = dictTraversableWithIndex => {
  ...
  return {
    traverseWithIndex: dictApplicative => {
      ...
      return f => v => Apply0.apply(Apply0.Functor0().map(NonEmpty)(f(Data$dMaybe.Nothing)(v._1)))(traverseWithIndex1(Control$dSemigroupoid.composeImpl(f)(Data$dMaybe.Just))(v._2));
    },

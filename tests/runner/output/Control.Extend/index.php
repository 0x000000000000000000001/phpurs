...
\PhpursThunks::$thunks['Control_Extend_extendArray'] = function() { $v = (object)["extend" => ($GLOBALS['Control_Extend_arrayExtend'] ?? \PhpursThunks::eval('Control_Extend_arrayExtend')), "Functor0" => function($dollar__unused_0 = null) {
  $__num = \func_num_args();

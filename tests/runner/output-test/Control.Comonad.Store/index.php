...
function majControl_majComonad_majStore_store($f_0, $x_1 = null) {
  ...
  $__res = (($GLOBALS['Data_Function_apply'])($GLOBALS['Control_Comonad_Store_Trans_StoreT']))((($GLOBALS['Data_Tuple_Tuple'])($f_0))($x_1));
  goto __end;;
  __end:
...
function majControl_majComonad_majStore_runmajStore($v_0) {
  ...
  $__res = ($GLOBALS['Data_Tuple_swap'])(((($GLOBALS['Data_Functor_map'])($GLOBALS['Data_Tuple_functorTuple']))(($GLOBALS['Data_Newtype_unwrap'])(null)))(($GLOBALS['Data_Tuple_swap'])($v_0)));
  goto __end;;
  __end:

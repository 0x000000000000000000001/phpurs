...
const traverseWithIndex_ = dictApplicative => {
  ...
  return dictFoldableWithIndex => f => dictFoldableWithIndex.foldrWithIndex(i => Control$dSemigroupoid.composeImpl(a => b => $0.apply($0.Functor0().map(v => Control$dApply.identity)(a))(b))(f(i)))(dictApplicative.pure());
};
...
const foldableWithIndexCompose = dictFoldableWithIndex => {
  ...
  return dictFoldableWithIndex1 => {
    const foldlWithIndex2 = dictFoldableWithIndex1.foldlWithIndex;
    ...
    return {
      ...
      foldlWithIndex: f => i => v => dictFoldableWithIndex.foldlWithIndex(Control$dSemigroupoid.composeImpl(foldlWithIndex2)(a => b => f(Data$dTuple.$Tuple(a, b))))(i)(v),
      foldMapWithIndex: dictMonoid => {
        ...
        return f => v => foldMapWithIndex3(Control$dSemigroupoid.composeImpl(foldMapWithIndex4)(a => b => f(Data$dTuple.$Tuple(a, b))))(v);
      },
  ...
  return dictFoldableWithIndex1 => {
    ...
    return {
      ...
      foldMapWithIndex: dictMonoid => {
        ...
        const foldMapWithIndex4 = dictFoldableWithIndex1.foldMapWithIndex(dictMonoid);
        return f => {
          const $0 = foldMapWithIndex3(Control$dSemigroupoid.composeImpl(f)(Data$dEither.Left));
          const $1 = foldMapWithIndex4(Control$dSemigroupoid.composeImpl(f)(Data$dEither.Right));
          return v2 => {
            if (v2.tag === "Left") { return $0(v2._1); }
            if (v2.tag === "Right") { return $1(v2._1); }
            $runtime.fail();
  ...
  return dictFoldableWithIndex1 => {
    ...
    return {
      ...
      foldMapWithIndex: dictMonoid => {
        const foldMapWithIndex3 = dictFoldableWithIndex.foldMapWithIndex(dictMonoid);
        const foldMapWithIndex4 = dictFoldableWithIndex1.foldMapWithIndex(dictMonoid);
        return f => v => dictMonoid.Semigroup0().append(foldMapWithIndex3(Control$dSemigroupoid.composeImpl(f)(Data$dEither.Left))(v._1))(foldMapWithIndex4(Control$dSemigroupoid.composeImpl(f)(Data$dEither.Right))(v._2));
      },
...
const foldlWithIndexDefault = dictFoldableWithIndex => {
  ...
  return c => u => xs => foldMapWithIndex1(i => Control$dSemigroupoid.composeImpl(Data$dMonoid$dDual.Dual)(Control$dSemigroupoid.composeImpl(Data$dMonoid$dEndo.Endo)((() => {
    const $0 = c(i);
    return b => a => $0(a)(b);
  })())))(xs)(u);
};
const foldrWithIndexDefault = dictFoldableWithIndex => {
  ...
  return c => u => xs => foldMapWithIndex1(i => Control$dSemigroupoid.composeImpl(Data$dMonoid$dEndo.Endo)(c(i)))(xs)(u);
};
...
const anyWithIndex = dictFoldableWithIndex => dictHeytingAlgebra => {
  ...
  return t => Control$dSemigroupoid.composeImpl(Unsafe$dCoerce.unsafeCoerce)(foldMapWithIndex2(i => Control$dSemigroupoid.composeImpl(Data$dMonoid$dDisj.Disj)(t(i))));
};
const allWithIndex = dictFoldableWithIndex => dictHeytingAlgebra => {
  ...
  return t => Control$dSemigroupoid.composeImpl(Unsafe$dCoerce.unsafeCoerce)(foldMapWithIndex2(i => Control$dSemigroupoid.composeImpl(Data$dMonoid$dConj.Conj)(t(i))));
};
export {
  allWithIndex,
  anyWithIndex,
